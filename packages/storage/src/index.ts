/**
 * @sentinel/storage — Storage abstraction and SQLite adapter
 *
 * Provides a persistence layer for Sentinel's local data:
 * project metadata, file index, session history, memory entries.
 * The abstraction ensures Sentinel is not coupled directly to SQLite.
 */
...
/**
 * Abstract storage adapter. Sentinel's persistence layer depends on
 * this interface, not on SQLite directly.
 */
 ...
 * Data is stored as JSON in a simple key-value table per collection.
 */
